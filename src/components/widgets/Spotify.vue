<template>
  <div class="spotify-widget" ref="spotifyWidget">
    ...
    <div class="playlist-container" ref="playlistContainer">
      <iframe ref="spotifyEmbed" allowfullscreen=""
        allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
    </div>
    <div class="error-message" v-if="error">Invalid Spotify link, please try again.</div>
    <div class="widget-footer">
      <input type="text" v-model="mediaUrl" placeholder="Enter Spotify Media URL" @keypress.enter.prevent="loadMedia" />
...
export default {
  setup() {
    ...
    const extractTypeAndIdFromUrl = (url) => {
      const match = url.match(/(?:playlist|track|album|episode|show)\/([a-zA-Z0-9]+)(?:\?si=([a-zA-Z0-9]+))?/);
    ...
    const loadDefaultPlaylist = () => {
      const defaultPlaylistUrl = "https://open.spotify.com/playlist/0vvXsWCC9xrXsKd4FyS8kM?si=b5a59d64ba224b71";
